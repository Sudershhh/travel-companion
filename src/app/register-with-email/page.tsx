...
function RegisterWithPage() {
  ...
  return (
    ...
    <>
      ...
      <p className="text-center mb-4">Use a minimum of 10 characters, including letters, lowercase letters, and numbers.</p>
      ...
      <form onSubmit={handleSubmit(handleUserRegister)}>
        ...
        <div className="mb-4 relative">
          ...
          <button
                ...
                >
                  {showConfirmPassword ? <EyeClosedIcon className="h-5 w-5 text-gray-400" /> : <EyeOpenIcon className="h-5 w-5 text-gray-400" />}
                </button>
          </div>
        </div>
      <button
