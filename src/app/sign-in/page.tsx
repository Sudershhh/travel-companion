...
<Header />
      <section className="flex flex-col justify-center w-full items-center h-screen bg-white">
        ...
        <div className="w-full max-w-md p-8  rounded-lg max-h-full">
          <form onSubmit={handleSubmit(handleSignIn)}>
            <div className="mb-4">
              ...
              <input
                ...
                className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 h-10 bg-gray-100 p-3 ${errors.email ? 'border-red-500' : ''}`}
            ...
            <div className="mb-4 relative">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 h-10 bg-gray-100 p-3 pr-10 ${errors.password ? 'border-red-500' : ''}`}
              ...
              <a href="#" className="text-blue-500 block text-sm mt-1 text-right font-semibold">Forgot password?</a>
            </div>
            <div className="mt-4">
              <button
                type="submit"
          ...
          <p className="text-md mt-8 text-center">Don&apos;t have an account? <Link href="/register" className="text-blue-400 font-medium">
            Register
          </Link></p>
        </form>
      </div>
